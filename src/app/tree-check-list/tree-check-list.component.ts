...
import { ChecklistDatabase, TodoItemFlatNode, TodoItemNode } from '../service/checklist-database.service';
import {MatTreeFlatDataSource, MatTreeFlattener} from '@angular/material/tree';
import {SelectionModel} from '@angular/cdk/collections';
import {FlatTreeControl} from '@angular/cdk/tree';

@Component({
  selector: 'tree-check-list',
...
export class TreeCheckListComponent {
  ...
  public deleteNode(node: TodoItemFlatNode): void {
  ...
  //   const removeNode = this.flatNodeMap.get(node);
  ...
  // deleteNode(node:TodoItemNode, tree){
